...
///////////////////////
builder.Services.AddScoped <ClinicDashboardService>();
builder.Services.AddTransient<IClinicDashboardService, ClinicDashboardService>();
builder.Services.AddTransient<IClinicDashboardRepository, ClinicDashboardRepository>();
