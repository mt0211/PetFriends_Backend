...
///////////////////////
builder.Services.AddScoped<ServiceDemandService>();
builder.Services.AddTransient<IServiceDemandService, ServiceDemandService>();
builder.Services.AddTransient<IServiceDemandRepository, ServiceDemandRepository>();
