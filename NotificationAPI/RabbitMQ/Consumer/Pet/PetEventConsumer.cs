...
public class PetEventConsumer : BackgroundService
{
    ...
    private const string ExchangeName = "pet_birthday_events";

    public PetEventConsumer(IServiceProvider serviceProvider)
    {
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += async (model, ea) =>
        {
              ...
              using (var scope = _serviceProvider.CreateScope())
              {
                ...
                var petEvent = JsonSerializer.Deserialize<PetEvent>(message);
                await activityService.CreatePetBirthdayNotification(
