...
public class PromotionEventConsumer : BackgroundService
{
    private readonly IConnection _connection;
    private readonly IModel _channel;
    private readonly IServiceProvider _serviceProvider;
    private readonly string _queueName;
    private const string ExchangeName = "promotion_notification_events";

    public PromotionEventConsumer(IServiceProvider serviceProvider)
    {
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += async (model, ea) =>
        {
            ...
            using (var scope = _serviceProvider.CreateScope())
            {
                ...
                var promotionEvent = JsonSerializer.Deserialize<PromotionEvent>(message);
                await activityService.CreatePromotionNotification(
                    promotionEvent.Type,
