...
public class RabbitMQService : IMessageBus
{
    ...
    private const string PromotionNotificationExchangeName = "promotion_notification_events";
    ...
    public RabbitMQService()
    {
        ...
        _channel.ExchangeDeclare(PromotionNotificationExchangeName, ExchangeType.Fanout);
    }
    ...
    public void PublishPormotionNotification(string type, Guid promotionId)
    {
        var message = JsonSerializer.Serialize(new
        {
            Type = type,
        ...
        var body = Encoding.UTF8.GetBytes(message);
        _channel.BasicPublish(
            exchange: PromotionNotificationExchangeName,
            routingKey: "",
            basicProperties: null,
            body: body);
    }
